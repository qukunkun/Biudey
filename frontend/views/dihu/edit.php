...
<form id="release-form" class="form-horizontal" role="form" action="/dihu/do_release" enctype="multipart/form-data" method="post">
    ...
    <div class="row">
        <div class="col-lg-12 form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" id="contact_user" name="contact_user" placeholder="请输入您的称呼">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12 form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" id="contact_phone" name="contact_phone" placeholder="请输入联系电话">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12 form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" id="area" name="area" placeholder="请输入面积（平方米）">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12 form-group">
            ...
            <div class="col-lg-10">
                <input type="text" class="form-control" id="price" name="price" placeholder="请输入金额">
            </div>
        </div>
    </div>
